...
export default function Sidebar({ collapsed, onToggleCollapse }) {
  ...
  const navLinks = [
    ...
    { name: "Links", to: "/app/links", icon: LinkIcon, description: "Manage your links" },
  ...
  return (
    <motion.div 
      initial={{ x: -300 }}
      animate={{ x: 0 }}
      className={`fixed top-0 left-0 h-full bg-white shadow-lg border-r border-gray-200 z-40 flex flex-col ${
        collapsed ? "w-16" : "w-64"
